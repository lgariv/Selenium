...
@class SBNCNotificationDispatcher; @class PCPersistentTimer; @class SBNCSoundController; @class CSNotificationDispatcher; @class SBFStaticWallpaperView; @class NCNotificationStructuredListViewController; @class NCNotificationListCellActionButtonsView; @class NCNotificationCombinedListViewController; @class SBNotificationBannerDestination; @class NCNotificationManagementAlertController; @class SpringBoard; @class SBFLockScreenDateView; @class SBNCScreenController; @class SBDashBoardCombinedListViewController; @class CSCombinedListViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_e50818bf(int __unused argc, char __unused **argv, char __unused **envp){
    preferencesChanged();

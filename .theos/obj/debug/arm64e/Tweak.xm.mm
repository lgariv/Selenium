...
@class NCNotificationManagementAlertController; @class PCPersistentTimer; @class SBFLockScreenDateView; @class NCNotificationListCellActionButtonsView; @class CSNotificationDispatcher; @class CSCombinedListViewController; @class SpringBoard; @class SBNotificationBannerDestination; @class NCNotificationStructuredListViewController; @class SBNCNotificationDispatcher; @class SBNCScreenController; @class SBNCSoundController; @class SBDashBoardCombinedListViewController; @class NCNotificationCombinedListViewController; @class SBFStaticWallpaperView; 

static __inline__ __attribute__((always_inline)) __attribute__((unused)) Class _logos_static_class_lookup$PCPersistentTimer(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("PCPersistentTimer"); } return _klass; }static __inline__ __attribute__((always_inline)) __attribute__((unused)) Class _logos_static_class_lookup$NCNotificationManagementAlertController(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("NCNotificationManagementAlertController"); } return _klass; }
#line 39 "Tweak.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_c95824bf(int __unused argc, char __unused **argv, char __unused **envp){
    preferencesChanged();
